...
use iboxs\migration\NullOutput;
...
abstract class AbstractAdapter implements AdapterInterface
{
     ...
     * @param \iboxs\console\Input|null $input Input Interface
     * @param \iboxs\console\Output|null $output Output Interface
     */
    ...
    {
        /** @var \iboxs\console\Input|null $input */
        $input = $this->getInput();
