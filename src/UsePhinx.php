            ...
            if (is_dir($from)) {
                ...
                foreach ($finder as $file) {
                    ...
                    try {
                        ...
                        $replaces = [
                            'use Symfony\Component\Console\Input\InputInterface;'   => 'use iboxs\console\Input as InputInterface;',
                            'use Symfony\Component\Console\Output\OutputInterface;' => 'use iboxs\console\Output as OutputInterface;',
                            '\Symfony\Component\Console\Output\OutputInterface'     => '\iboxs\console\Output',
                            '\Symfony\Component\Console\Input\InputInterface'       => '\iboxs\console\Input',
                            'use Symfony\Component\Console\Output\NullOutput;'      => 'use iboxs\migration\NullOutput;',
                        ];
